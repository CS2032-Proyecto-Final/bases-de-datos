...
LOG_FILE_PATH = "/logs/load_environments.log"
...
BOOKS_SUBFOLDER = "environments"  # Carpeta en el bucket para almacenar los .csv de environments
...
# Función para realizar la ingesta de archivos de environments
def ingest():
    stage = os.environ.get("STAGE")  # Prefijo basado en el entorno
    logger.info(f"Iniciando ingesta para el stage '{stage}' en el contenedor 't_environments'")
