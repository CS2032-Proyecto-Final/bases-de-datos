...
LOG_FILE_PATH = "/logs/load_favorites.log"
...
BOOKS_SUBFOLDER = "favorites"  # Carpeta en el bucket para almacenar los .csv de favoritos
...
# Función para realizar la ingesta de archivos de favoritos
def ingest():
    stage = os.environ.get("STAGE")  # Prefijo basado en el entorno
    logger.info(f"Iniciando ingesta para el stage '{stage}' en el contenedor 't_favorites'")
